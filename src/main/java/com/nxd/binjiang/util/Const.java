...
public class Const {
    ...
    public static final String FILE_PATHFILE_HOTEL = "uploadFiles/file/hotel/";        //文件上传路径
    public static final String FILEPATHTWODIMENSIONCODE = "uploadFiles/twoDimensionCode/"; //二维码存放路径
    public static final String NO_INTERCEPTOR_PATH = ".*/((login)|(toLogin)|(toIndex)|(code)|(pages)|(page)|(static)|(plugins)|(uploadFiles)|(wechat)|(picture)).*";    //不对匹配该值的访问路径拦截（正则）
